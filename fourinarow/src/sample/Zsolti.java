...
public class Zsolti {
    ...
    public void selectTile(MouseEvent mouseEvent) throws IOException {
        ...
        if (now.equals("move") && feher){
            ...
            soutCurrentPlayerName(current, currentPlayer, currentPlayer);
        }
        ...
        if(
            ...
            //throw IOException;
            App.setRoot("zsoltiwin");
            soutCurrentPlayerName(winner,"Blue player won", "blue");

        }
    }

    public void soutCurrentPlayerName(Label label1, String player, String color){
        label1.setText("Most lép: " + player);
